        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f8fafc; padding: 20px; border: 1px solid #e2e8f0; border-top: none;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
              <tr>
                <td style="padding: 8px; font-weight: bold; background: #f1f5f9;">Glider Name:</td>
                <td style="padding: 8px; background: white;">${request.gliderName}</td>
              </tr>
              <tr>
                <td style="padding: 8px; font-weight: bold; background: #f1f5f9;">Order Number:</td>
                <td style="padding: 8px; background: white;">${request.orderNumber}</td>
              </tr>
              <tr>
                <td style="padding: 8px; font-weight: bold; background: #f1f5f9;">Reason:</td>
                <td style="padding: 8px; background: white;">${request.reason}</td>
              </tr>
              <tr>
                <td style="padding: 8px; font-weight: bold; background: #f1f5f9;">Status:</td>
                <td style="padding: 8px; background: white;">
                  <span style="background: #fbbf24; color: #92400e; padding: 4px 8px; border-radius: 4px; font-size: 12px; font-weight: bold;">
                    ${request.status}
                  </span>
                </td>
              </tr>
              <tr>
                <td style="padding: 8px; font-weight: bold; background: #f1f5f9;">Submitted:</td>
                <td style="padding: 8px; background: white;">${new Date(request.submittedAt).toLocaleString()}</td>
              </tr>
            </table>

            <h3 style="color: #1e40af; margin-top: 25px;">Panel Information</h3>
            <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
              <thead>
                <tr style="background: #1e40af; color: white;">
                  <th style="padding: 10px; text-align: left;">Panel Number</th>
            ...
            ${request.notes ? `
              <h3 style="color: #1e40af; margin-top: 25px;">Additional Notes</h3>
